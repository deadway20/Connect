package com.coder_x.connect.onboarding
...
import com.coder_x.connect.helpers.DataBaseHelper.insertEmployee
...
class EmployeeDataFragment : Fragment(), ImageHelper.OnImageSelectedListener {
    ...
    private fun saveEmployeeData() {
        ...
        if (imageUri != null) {
            prefsHelper.putEmployeeImage(requireContext(), imageUri!!)
        }
